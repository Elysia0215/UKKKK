...
const SUB_TO_PARENT_MAP: Record<string, { cat1: string; lifecycle: string }> = {
  // 1. 임신·난임·생식건강
  ...
  '지역 간 혜택 형평성': { cat1: '다자녀·양육비·생활지원', lifecycle: '양육기 생활지원' },

  // 5. 주거·교통·도시생활환경 (사용자 강조 신규 강화 축 3개)
  ...
  '위기임산부': { cat1: '취약·다양가족 사각지대', lifecycle: '사각지대 보호' },
...
const CAT1_TO_LIFECYCLE: Record<string, string> = {
...
const LIFECYCLE_TO_CAT1: Record<string, string> = {
