      ...
      },
      {
        ...
        body: reportType === 'detailed'
          ? [
              ...
              '마. [박미경 (2022) / 우선순위] 가설: MZ세대가 지각하는 저출산 대응정책 요구도에 영역 간 뚜렷한 우선순위가 존재할 것이다. ➔ 검증: 청년 세대 설문 기반 Borich 요구도 분석 및 IPA(중요도-수행도) 분석 ➔ 결과: 자녀양육지원(1순위) > 출산지원(2순위) > 일·가정양립 지원(3순위) 순으로 요구도가 높음을 실증 ➔ 결론: 대시보드 내 카테고리별 시급성 및 공감수 결합 가중합 점수 모델링 지지.',
              ...
              '사. ⚠️ [홍향희·이정화 (2026) / 미검증 연구] 가설: 현금 지원보다 보육 인프라 편의성 요구가 민원의 주류 쟁점일 것이다. ➔ 검증: 국민신문고 접수 저출산 민원 대상 CONCOR 및 텍스트마이닝 클러스터링 ➔ 결과: 단순 수당 불만 대비 시간제 보육 편의성, 맞벌이 돌봄 공백 해소가 지배 쟁점으로 도출 ➔ 결론: 돌봄 안전망의 시간적/공간적 연속성 보장 필요성 지지 (KCI 미색인 상태로 인용 주의)'
            ]
          : [
